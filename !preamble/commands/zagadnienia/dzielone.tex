...
\refstepcounter{zagc}% 
\subsection*{{\reversemarginpar\marginnote{{\linin\arabic{zagc}}.\\#3}}#2}% bez numeru w nazwie
\phantomsection\label{zag:\arabic{zagc}}% label z numerem subsekcji (zag:n.m)
